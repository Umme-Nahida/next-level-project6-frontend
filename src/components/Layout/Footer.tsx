            ...
            <div className="container mx-auto  space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <div className="text-primary dark:text-ring flex items-center justify-start">
                        <Logo></Logo>
                        <h1 className="text-3xl font-bold italic">Find Rider</h1>
                    </div>
                ...
                <div
                    className="grid grid-cols-1 gap-8 border-t border-gray-400 pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16 dark:border-gray-800"
                >
                    <div>
